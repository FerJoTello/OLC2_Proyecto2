...
class Ui_MainWindow(object):
    ...
    def acercade(self):
        ...
        msg.setText("Proyecto 2 - MINOR C\nFernando Tello 201800714\nCompiladores 2 Vacaciones Junio\nUtilizando el primero proyecto elaborado por: Haroldo Arias 201020247 (Gracias crack).")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Proyecto2 - OLC2"))
